...
_MEMBERSHIPSTATE_ADDSETENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="MembershipState.AddSetEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="MembershipState.AddSetEntry.value",
            index=1,
            number=2,
            type=4,
            cpp_type=4,
...
_MEMBERSHIPSTATE_REMOVESETENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="MembershipState.RemoveSetEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="MembershipState.RemoveSetEntry.value",
            index=1,
            number=2,
            type=4,
            cpp_type=4,
...
_MEMBERSHIPSTATE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="replica_id",
            full_name="MembershipState.replica_id",
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="peer_addr",
            full_name="MembershipState.peer_addr",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="add_set",
            full_name="MembershipState.add_set",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="remove_set",
            full_name="MembershipState.remove_set",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
...
_MEMBERSHIPPINGREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="peer_id",
            full_name="MembershipPingRequest.peer_id",
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="peer_addr",
            full_name="MembershipPingRequest.peer_addr",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_MEMBERSHIPSTATE.fields_by_name[
    "remove_set"
].message_type = _MEMBERSHIPSTATE_REMOVESETENTRY
...
MembershipState = _reflection.GeneratedProtocolMessageType(
    "MembershipState",
    (_message.Message,),
    {
        "AddSetEntry": _reflection.GeneratedProtocolMessageType(
            "AddSetEntry",
            (_message.Message,),
            {
        ...
        "RemoveSetEntry": _reflection.GeneratedProtocolMessageType(
            "RemoveSetEntry",
            (_message.Message,),
            {
...
MembershipPingRequest = _reflection.GeneratedProtocolMessageType(
    "MembershipPingRequest",
    (_message.Message,),
    {
